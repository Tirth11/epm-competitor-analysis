...
export type CuratedFeature = {
  ...
  category: string;
  subCategory?: string;
  status?: 'Available' | 'Partial' | 'Planned' | 'Deprecated' | 'Unknown';
  description?: string;
  references?: string[];
};

export type CuratedUseCase = {
  title: string;
  category: string;
  industry?: string;
  problem: string;
...
export type CuratedSource = {
  type: 'product_page' | 'docs' | 'release_notes' | 'blog' | 'datasheet' | 'youtube';
  url: string;
};
...
const beyondtrust: CuratedProduct = {
...
const me_endpoint_central: CuratedProduct = {
...
const me_pam360: CuratedProduct = {
...
const policypak: CuratedProduct = {
...
const intune_epm: CuratedProduct = {
...
const ivanti_em: CuratedProduct = {
...
const ivanti_app_control: CuratedProduct = {
...
const adminbyrequest: CuratedProduct = {
...
const threatlocker: CuratedProduct = {
  name: 'ThreatLocker',
  vendor: 'ThreatLocker',
  productType: 'EPM',
...
const oneidentity: CuratedProduct = {
...
const sentinelone: CuratedProduct = {
...
const crowdstrike: CuratedProduct = {
...
const cortex_xdr: CuratedProduct = {
...
const sophos_intercept: CuratedProduct = {
...
const cybereason: CuratedProduct = {
...
const trendmicro: CuratedProduct = {
...
const bitdefender: CuratedProduct = {
...
const carbonblack: CuratedProduct = {
...
export const CATALOG: CuratedProduct[] = [
  arconEpm,
  // EPM competitors
  cyberark,
  beyondtrust,
